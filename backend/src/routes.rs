...
struct ConfigStatusResponse {
    ...
    live_market_ingestion_enabled: bool,
    live_market_symbols: Vec<String>,
    live_market_poll_interval_seconds: u64,
    live_market_provider_name: String,
    live_market_provider_base_url_configured: bool,
    news_provider_key_configured: bool,
    news_provider_name: String,
    news_provider_base_url_configured: bool,
    news_provider_request_timeout_seconds: u64,
...
async fn config_status(State(state): State<AppState>) -> Json<ConfigStatusResponse> {
    ...
    Json(ConfigStatusResponse {
        ...
        live_market_ingestion_enabled: config.live_market_ingestion_enabled,
        live_market_symbols: config.live_market_symbols.clone(),
        live_market_poll_interval_seconds: config.live_market_poll_interval_seconds,
        live_market_provider_name: config.live_market_provider_name.clone(),
        live_market_provider_base_url_configured: config.live_market_provider_base_url.is_some(),
        news_provider_key_configured: !config.news_provider_key.is_empty(),
        news_provider_name: config.news_provider_name.clone(),
        news_provider_base_url_configured: config.news_provider_base_url.is_some(),
        news_provider_request_timeout_seconds: config.news_provider_request_timeout_seconds,
